                  ...
                  <tr key={t.id} style={{ borderTop: '0.5px solid #f0f0ec' }}>
                    ...
                    <td style={{ padding: '10px 12px' }}>
                      <select
                        ...
                        style={{ fontSize: 11, padding: '3px 6px', borderRadius: 5, border: '0.5px solid #ccc', cursor: 'pointer', background: t.plan === 'pro' ? '#F5F3FF' : t.plan === 'growth' ? '#F0FDF4' : '#fff', color: t.plan === 'pro' ? '#7C3AED' : t.plan === 'growth' ? '#15803D' : '#374151', fontWeight: t.plan !== 'starter' ? 700 : 400 }}>
