...
export default function Settings() {
  ...
  function handleFbLogin() {
    ...
    const url = `https://www.facebook.com/v19.0/dialog/oauth?client_id=${appId}&redirect_uri=${encodeURIComponent(redirectUri)}&scope=pages_show_list,pages_manage_metadata,pages_messaging,pages_read_engagement,business_management&response_type=code&state=${state}`;
