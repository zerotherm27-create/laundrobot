...
// How much of a tenant's ai_instructions the system prompt carries. The save
// validator in routes/tenants.js imports this so the two can't drift apart.
...
module.exports = { askGemini, formatActiveBookings, AI_INSTRUCTIONS_MAX };
